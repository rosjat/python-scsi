...
mode_parameter_header6_bits = {
    "medium_type": [0xFF, 1],
    "device_specific_parameter": [0xFF, 2],
}

mode_parameter_header10_bits = {
    "medium_type": [0xFF, 2],
...
power_condition_bits = {
    "pm_bg_precedence": [0xC0, 2],
    "standby_y": [0x01, 1],
    "idle_c": [0x08, 3],
    "idle_b": [0x04, 3],
    "idle_a": [0x02, 3],
...
power_consumption_bits = {
    "POWER_CONSUMPTION_IDENTIFIER": [0xFF, 7],
}

protocol_specific_logical_unit_bits = {
    "protocol_specific_mode_parameters": [0xF0, 2],
