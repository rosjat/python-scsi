...
class UnmarshallReadelementstatusTest(unittest.TestCase):
    def test_main(self) -> None:
        with MockSCSI(MockReadElementStatus(smc)) as s:
            ...
            self.assertEqual(
                page["element_descriptors"][0]["additional_sense_code"], 55
            )
            self.assertEqual(
                page["element_descriptors"][0]["additional_sense_code_qualifier"], 56
            )
            ...
            self.assertEqual(
                page["element_descriptors"][0]["source_storage_element_address"], 27
            )
            ...
            self.assertEqual(
                page["element_descriptors"][0]["source_storage_element_address"], 28
            )
            ...
            self.assertEqual(
                page["element_descriptors"][1]["additional_sense_code"], 55
            )
            self.assertEqual(
                page["element_descriptors"][1]["additional_sense_code_qualifier"], 56
            )
            ...
            self.assertEqual(
                page["element_descriptors"][1]["source_storage_element_address"], 29
            )
